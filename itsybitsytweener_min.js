...
return t?0:"function"==typeof window.requestTimeout?requestTimeout(function(){e.run()},50):setTimeout(function(){e.run()},50)}},easer={cl:.3/(2*Math.PI)*Math.asin(1),pi3:2*Math.PI/.3,easeInOutQuad:function(t){return(t*=.5)<1?.5*t*t:-.5*(--t*(t-2)-1)},easeOutElastic:function(t){return 0==t||1==t?t:Math.pow(2,-10*t)*Math.sin((t-easer.cl)*easer.pi3)+1},easeOutBounce:function(t){return.36364>t?7.5625*t*t:.7273>t?7.5625*(t-=.5454)*t+.75:.9091>t?7.5625*(t-=.8182)*t+.9375:7.5625*(t-=.95454)*t+.984375},easeInOutSine:function(t){return-.5*(Math.cos(Math.PI*t)-1)},hexToRgb:function(t){var e=/^#?([a-f\d])([a-f\d])([a-f\d])$/i,n=t.replace(e,function(t,e,n,i){return e+e+n+n+i+i}),i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(n)
